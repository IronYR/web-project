    ...
    <section className="pt-12 md:pt-16 lg:pt-10 pb-5">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="flex flex-col items-center rounded-lg bg-white p-4 transition-all hover:scale-105 dark:bg-gray-950 cursor-pointer" onClick={() => navigate(`/products?category=ceramic`)}>
            ...
            <h3 className="mb-2 text-lg font-semibold">Ceramics</h3>
          </div>
          <div className="flex flex-col items-center rounded-lg bg-white p-4 transition-all hover:scale-105 dark:bg-gray-950 cursor-pointer " onClick={() => navigate(`/products?category=textile`)}>
            ...
            <h3 className="mb-2 text-lg font-semibold">Textiles</h3>
          </div>
          <div className="flex flex-col items-center rounded-lg bg-white p-4 transition-all hover:scale-105 dark:bg-gray-950 cursor-pointer" onClick={() => navigate(`/products?category=wood`)}>
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50">
              <img src={Woodwork} className="h-12 w-12" />
            </div>
            <h3 className="mb-2 text-lg font-semibold">Woodworks</h3>
          </div>
          <div className="flex flex-col items-center rounded-lg bg-white p-4 transition-all hover:scale-105 dark:bg-gray-950 cursor-pointer" onClick={() => navigate(`/products?category=leather`)}>
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50">
              <img src={Leatherwork} className="h-10 w-10" />
            </div>
            <h3 className="mb-2 text-lg font-semibold">Leatherworks</h3>
          </div>
        </div>
      </div>
    </section>
